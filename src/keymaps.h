...
enum { QWERTY, FUNCTION, NUMPAD };  // Keyboard layers

// Define some special key combos. While we could use macros, this is easier,
// cheaper, and accomplishes the same thing.
